...
var MongoDBCDCListenerModule = function () {
    function e() { }
    return e = __decorate([core_1.NgModule({
        ...
        declarations: [],
        entryComponents: [],
        providers: [{ provide: wi_contrib_1.WiServiceContribution, useClass: handler_1.MongoDBCDCListenerHandler }],
        bootstrap: []
    })], e);
}();

exports.default = MongoDBCDCListenerModule;
