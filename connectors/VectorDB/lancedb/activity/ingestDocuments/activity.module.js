...
var wi_contrib_1 = require("wi-studio/app/contrib/wi-contrib"),
    ...
    IngestDocumentsActivityHandlerModule = function () {
        function e() { }
        e = __decorate([core_1.NgModule({
            ...
            declarations: [],
            entryComponents: [],
            providers: [{ provide: wi_contrib_1.WiServiceContribution, useClass: activity_1.IngestDocumentsActivityHandler }],
            bootstrap: []
        })], e);
        return e;
    }();
exports.default = IngestDocumentsActivityHandlerModule;
