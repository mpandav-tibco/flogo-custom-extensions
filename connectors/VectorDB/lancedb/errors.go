...
var ErrorMessages = map[string]string{
	ErrCodeInvalidDBType:         "DBType must be: lancedb",
	...
	ErrCodeAuthFailed:            "Authentication failed — check credentials",
...
// NewError creates a VDBError with a structured error code.
