...
Embed raw text documents and store the resulting vectors in Azure AI Search in a single step. This is the recommended activity for RAG ingestion pipelines.
