...
Semantic ANN similarity search in Azure AI Search using a dense query vector. Returns the most similar documents ranked by score.
...
| `filters` | object | — | Metadata pre-filter (provider: Azure AI Search) |
