...
Paginate through all documents in a Azure AI Search collection without a query vector.

Uses Azure AI Search `$skip`/`$top` pagination. `NextOffset` is the skip count as a string.
