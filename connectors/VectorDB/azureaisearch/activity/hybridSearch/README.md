...
Combined dense vector + keyword search in Azure AI Search with configurable alpha blend. Returns results fused from both retrieval modes.

**Implementation**: Native: Azure AI Search RRF (Reciprocal Rank Fusion) combining dense vector and BM25 keyword results.
...
Native: Azure AI Search RRF (Reciprocal Rank Fusion) combining dense vector and BM25 keyword results.
