...
Generate dense vector embeddings from text using a configurable embedding provider. This activity is provider-agnostic — it does not interact with Azure AI Search directly.
