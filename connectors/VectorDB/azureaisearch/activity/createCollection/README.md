...
Create a new vector collection (index) in the Azure AI Search database. Collections must exist before documents can be upserted.
...
Index names must be lowercase alphanumeric with hyphens only. Azure is cloud-only — no Docker image available.
