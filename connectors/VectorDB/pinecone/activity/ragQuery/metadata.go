...
type Settings struct {
	...
	// UseHybridSearch enables Pinecone hybrid search (dense + sparse) instead of
	// pure vector search. When true, queryText is used to build the sparse vector
	// and queryVector for the dense component.
