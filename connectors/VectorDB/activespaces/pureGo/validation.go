...
// Batch size limit for this provider.
// ActiveSpaces recommends ≤1,000 points per request for typical latency;
// beyond ~1,000 × 1536-dim vectors the 16 MB default body limit is approached.
const (
	maxUpsertBatchActiveSpaces = 1_000
)
