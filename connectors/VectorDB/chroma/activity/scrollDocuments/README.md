...
|---|---|---|---|
| **VectorDB Connection** | Yes | — | The Chroma VectorDB connection |
...
| **Chroma** | **Client-side** | Fetches entire collection into memory, then slices. **Hard limit: 50,000 documents** — requests exceeding this cap return an error. Use Qdrant or Milvus for large collections. |
