...
Semantic ANN similarity search in Elasticsearch 8.x using a dense query vector. Returns the most similar documents ranked by score.
...
| `filters` | object | — | Metadata pre-filter (provider: Elasticsearch 8.x) |
