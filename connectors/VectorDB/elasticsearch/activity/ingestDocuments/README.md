...
Embed raw text documents and store the resulting vectors in Elasticsearch 8.x in a single step. This is the recommended activity for RAG ingestion pipelines.
