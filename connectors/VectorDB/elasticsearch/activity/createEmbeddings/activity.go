...
import (
	...
	vdbembed "github.com/mpandav-tibco/flogo-extensions/connectors/VectorDB/elasticsearch/embeddings"
...
func New(ctx activity.InitContext) (activity.Activity, error) {
	...
	if s.UseConnectorEmbedding && s.Connection != nil {
		...
		if !ok {
			return nil, fmt.Errorf("vectordb-embed: invalid connection type, expected *ElasticsearchConnection")
		}
