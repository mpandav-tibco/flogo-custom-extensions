...
Insert or update documents with pre-computed embedding vectors in Redis Stack (RediSearch).

Documents written as Redis hashes via HSET pipeline for efficiency.
