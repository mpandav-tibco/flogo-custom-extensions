...
Semantic ANN similarity search in Redis Stack (RediSearch) using a dense query vector. Returns the most similar documents ranked by score.
...
| `filters` | object | — | Metadata pre-filter (provider: Redis Stack (RediSearch)) |
