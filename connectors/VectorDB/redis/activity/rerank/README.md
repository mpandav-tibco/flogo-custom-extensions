...
Cross-encoder reranking of a candidate document set for improved retrieval precision. Reranks documents by semantic relevance to the query — this activity does not interact with Redis Stack (RediSearch) directly.
