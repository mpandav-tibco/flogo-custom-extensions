...
Semantic ANN similarity search in pgvector (PostgreSQL) using a dense query vector. Returns the most similar documents ranked by score.
...
| `filters` | object | — | Metadata pre-filter (provider: pgvector (PostgreSQL)) |
