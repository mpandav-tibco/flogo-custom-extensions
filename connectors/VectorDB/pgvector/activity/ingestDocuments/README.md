...
Embed raw text documents and store the resulting vectors in pgvector (PostgreSQL) in a single step. This is the recommended activity for RAG ingestion pipelines.
