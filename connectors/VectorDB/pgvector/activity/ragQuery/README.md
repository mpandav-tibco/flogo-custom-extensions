...
Full Retrieval-Augmented Generation (RAG) pipeline in one activity: embed the query text, search pgvector (PostgreSQL) for relevant documents, and format the results as context for an LLM.
