...
| **Use Hybrid Search** | No | `false` | Enable hybrid (BM25 + dense vector) search. Only Weaviate supports native hybrid search; Qdrant, Chroma, and Milvus fall back to dense vector search (Qdrant native hybrid is planned). |
