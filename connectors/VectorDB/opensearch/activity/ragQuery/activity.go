...
import (
	...
	"github.com/mpandav-tibco/flogo-extensions/connectors/VectorDB/opensearch"
	vectordbconnector "github.com/mpandav-tibco/flogo-extensions/connectors/VectorDB/opensearch/connector"
	vdbembed "github.com/mpandav-tibco/flogo-extensions/connectors/VectorDB/opensearch/embeddings"
...
type Activity struct {
	settings *Settings
	conn     *vectordbconnector.OpenSearchConnection
}
...
func New(ctx activity.InitContext) (activity.Activity, error) {
	...
	conn, ok := s.Connection.GetConnection().(*vectordbconnector.OpenSearchConnection)
	if !ok {
		return nil, fmt.Errorf("vectordb-rag: invalid connection type, expected *OpenSearchConnection")
	}
...
func (a *Activity) Eval(ctx activity.Context) (bool, error) {
	...
	if tc != nil {
		...
		tc.SetTag("db.vectordb.provider", "opensearch")
