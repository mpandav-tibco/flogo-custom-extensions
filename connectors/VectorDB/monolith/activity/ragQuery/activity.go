...
// ragLLMHTTPClient is a dedicated HTTP client for LLM generation calls.
// It uses conservative timeouts to avoid hanging on slow LLM endpoints while
// still allowing up to 120 s for the response headers (generation can be slow).
