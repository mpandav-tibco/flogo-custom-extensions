...
var wi_contrib_1 = require("wi-studio/app/contrib/wi-contrib"),
    ...
    VectorSearchActivityHandlerModule = function () {
        function e() { }
        e = __decorate([core_1.NgModule({
            ...
            declarations: [],
            entryComponents: [],
            providers: [{ provide: wi_contrib_1.WiServiceContribution, useClass: activity_1.VectorSearchActivityHandler }],
            bootstrap: []
        })], e);
        return e;
    }();
exports.default = VectorSearchActivityHandlerModule;
