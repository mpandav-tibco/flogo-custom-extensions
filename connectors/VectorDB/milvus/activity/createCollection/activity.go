...
func New(ctx activity.InitContext) (activity.Activity, error) {
	...
	if !ok {
		return nil, fmt.Errorf("vectordb-create-col: invalid connection type, expected *MilvusConnection")
	}
	ctx.Logger().Infof("CreateCollection initialised: connection=%s provider=%s", conn.GetName(), "milvus")
