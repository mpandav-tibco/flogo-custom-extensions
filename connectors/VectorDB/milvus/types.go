...
type ConnectionConfig struct {
	// DBType identifies this as a Milvus connection. Always "milvus".
	DBType string

	// Host is the Milvus server hostname or IP.
	Host string

	// Port is the Milvus gRPC port. Default: 19530.
	Port int

	// APIKey is reserved for future Milvus Cloud authentication.
	APIKey string
	...
	// DefaultMetricType is the distance metric for vector similarity searches.
	// Supported values: "cosine", "dot", "euclidean". Default: "cosine".
