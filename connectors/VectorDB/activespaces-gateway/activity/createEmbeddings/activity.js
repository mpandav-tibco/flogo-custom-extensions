...
Object.defineProperty(exports, "__esModule", { value: !0 }), exports.CreateEmbeddingsActivityHandler = void 0;
var core_1 = require("@angular/core"),
    ...
    CONNECTOR_INHERITED_FIELDS = ["provider", "apiKey", "baseURL"],

    CreateEmbeddingsActivityHandler = function (t) {
        function e(e, i) {
            ...
            n.value = function (fieldName, ctx) {
                if (fieldName === "connection") {
                    return rxjs_1.Observable.create(function (observer) {
                        var connections = [];
                        wi_contrib_1.WiContributionUtils.getConnections(n.http, "activespaces-gateway", "activespaces-gateway-connector").subscribe(
                            function (conns) {
...
exports.CreateEmbeddingsActivityHandler = CreateEmbeddingsActivityHandler;
