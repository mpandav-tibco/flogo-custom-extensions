...
It is the **gateway sibling** of the [ActiveSpaces Native (tibdg/CGO) connector](../activespaces-native/README.md);
both expose the identical 14-activity surface and differ only in *how* they reach the grid.
See the [connector comparison](../activespaces/README.md) to choose between them.
...
```bash
cd connectors/VectorDB/activespaces-gateway
