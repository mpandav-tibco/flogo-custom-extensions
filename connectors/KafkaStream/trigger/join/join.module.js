...
var joinHandler_1 = require("./joinHandler");
...
var joinModule = function () {
    ...
    return e = __decorate([core_1.NgModule({
        ...
        declarations: [],
        entryComponents: [],
        providers: [{ provide: wi_contrib_1.WiServiceContribution, useClass: joinHandler_1.joinHandler }],
        bootstrap: []
    })], e);
}();
exports.default = joinModule;
