...
var aggregateHandler_1 = require("./aggregateHandler");
...
var aggregateModule = function () {
    ...
    return e = __decorate([core_1.NgModule({
        ...
        declarations: [],
        entryComponents: [],
        providers: [{ provide: wi_contrib_1.WiServiceContribution, useClass: aggregateHandler_1.aggregateHandler }],
        bootstrap: []
    })], e);
}();
exports.default = aggregateModule;
