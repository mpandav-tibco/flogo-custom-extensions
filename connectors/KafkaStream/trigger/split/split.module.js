...
var splitHandler_1 = require("./splitHandler");
...
var splitModule = function () {
    ...
    return e = __decorate([core_1.NgModule({
        ...
        declarations: [],
        entryComponents: [],
        providers: [{ provide: wi_contrib_1.WiServiceContribution, useClass: splitHandler_1.splitHandler }],
        bootstrap: []
    })], e);
}();
exports.default = splitModule;
